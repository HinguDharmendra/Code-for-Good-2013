                                            ...
                                            <div class="cleared"></div>
                                              <div class="art-postcontent">
                                                ...
                                                try {
                                                        ...
                                                        String query = "select * from school where city like 'Mumbai'";
                                                        ...
                                                        while(rs.next()){
                                                            ...
                                                            out.print("<form action='school.jsp' method='post'><tr><td><p align='center'>"+school+"</p></td><td><p align='center'>"+schname+"</p></td><td><p align='center'>"+city+"</p></td><td><p align='center'><input type='hidden' name='schid' value='"+school+"'><input type='hidden' name='start0' value='Mumbai >'><input type='submit' name='view' value='View'/></input></p></td></tr></form>");
                                                        }
                                                    } catch (Exception e) {
                                                    }%>
